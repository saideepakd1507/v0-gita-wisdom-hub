  ...
  const chapter1Slokas: Partial<Sloka>[] = [
    {
      ...
      translations: {
        ...
        punjabi: 'ਧ੍ਰਿਤਰਾਸ਼ਟਰ ਨੇ ਕਿਹਾ: ਹੇ ਸੰਜੈ, ਧਰਮਕਸ਼ੇਤਰ ਕੁਰੂਕਸ਼ੇਤਰ ਵਿੱਚ ਯੁੱਧ ਲਈ ਇਕੱਠੇ ਹੋਏ ਮੇਰੇ ਅਤੇ ਪਾਂਡੂ ਦੇ ਪੁੱਤਰਾਂ ਨੇ ਕੀ ਕੀਤਾ?'
      },
    ...
    },
    {
      ...
      translations: {
        ...
        malayalam: 'സഞ്ജയൻ പറഞ്ഞു: രാജാവേ, പാണ്ഡവരുടെ വ്യൂഹരചിത സൈന്യം കണ്ട് രാജാ ദുര്യോധനൻ ദ്രോണാചാര്യരുടെ അടുക്കൽ ചെന്ന് പറഞ്ഞു.',
...
function generateChapter1Sloka(verse: number): Partial<Sloka> {
  ...
  const defaultSloka = createDefaultSloka(1, verse, 'Arjuna', ['fear', 'stress', 'relationships']);
  ...
  const keyVerses: Record<string, Omit<Sloka, 'id' | 'chapter' | 'verse' | 'speaker' | 'topics'>> = {
    ...
    '2.14': {
      ...
      translations: {
        ...
        telugu: 'ఓ కుంతీ పుత్రా, ఇంద్రియాలు వాటి విషయాలతో సంపర్కం చలి-వేడి, సుఖ-దుఃఖాలను ఇస్తుంది. అవి వచ్చి పోయేవి, అశాశ్వతమైనవి. ఓ భారతా, వాటిని ధైర్యంగా సహించు.',
    ...
    '3.21': {
      ...
      translations: {
        ...
        tamil: 'பெரிய தலைவர்கள் என்ன செயல்களைச் செய்கிறார்களோ, சாதாரண மக்கள் பின்பற்றுகிறார்கள். அவர்கள் தங்கள் முன்மாதிரியால் என்ன தரங்களை நிர்ணயிக்கிறார்களோ, உலகம் பின்பற்றுகிறது.',
        ...
        gujarati: 'શ્રેષ્ઠ પુરુષ જે જે આચરણ કરે છે, અન્ય લોકો પણ તેમ કરે છે. તે જે પ્રમાણ સ્થાપિત કરે છે, સંસાર તેનું અનુસરણ કરે છે.',
    ...
    '18.78': {
      ...
      translations: {
        ...
        marathi: 'जिथे योगेश्वर कृष्ण आहेत आणि जिथे धनुर्धर अर्जुन आहे, तिथे निश्चितच श्री, विजय, समृद्धी आणि नीती आहे. हे माझे मत आहे.',
        ...
        bengali: 'যেখানে যোগেশ্বর কৃষ্ণ আছেন এবং যেখানে ধনুর্ধর অর্জুন আছেন, সেখানে নিশ্চয়ই শ্রী, বিজয়, সমৃদ্ধি এবং নীতি আছে। এটা আমার মত।',
